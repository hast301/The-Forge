...
LibPath                := $(LibraryPathSwitch). $(LibraryPathSwitch)../OSBase/Release/ $(LibraryPathSwitch)../Renderer/Release/ $(LibraryPathSwitch)../SpirVTools/Release/ $(LibraryPathSwitch)$(VULKAN_SDK)/lib/ $(LibraryPathSwitch)../../../../Common_3/ThirdParty/OpenSource/assimp/4.1.0/lib/ 
